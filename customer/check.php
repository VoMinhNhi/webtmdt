  ...
  <div class="container">
    ...
    <div class="row mb-3">
      ...
      <div class="col style">
        ...
        <button type="button" class="btn btn-outline-danger ">Ví Online</button>
        <button type="button" class="btn btn-outline-danger">Thẻ Tín Dụng MasterCard </button>
        <button type="button" class="btn btn-outline-info active">Thanh Toán Khi Nhận Hàng <span class="badge"><i class="fa fa-check" aria-hidden="true"></i></span></button>
      </div>
      <div class="w-100"></div>
      <div class="line line-2"></div>
      <div class="col change">
        ...
        <div class="footer">
          <span class="black">Nhấn "Thanh Toán" đồng nghĩa với việc bạn đồng ý tuân theo <a href="#">Điều khoản
              An & Nhí Smart Services</a></span>
          <a class="btn btn-outline-success btn-lg" href="/website_tmdt/customer/purchared.php?giohang_array=<?= $giohang_array ?>">Thanh Toán</a>
        </div>
