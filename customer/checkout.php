  ...
  <div class="container">
    ...
    <div class="row mb-3">
      ...
      <div class="col style">
        ...
        <button type="button" class="btn btn-outline-info active">Thanh Toán Khi Nhận Hàng <span class="badge"><i
      ...
      <div class="col change">
        <div class="total-cost">
          ...
          <span>Tổng Thanh Toán: <b><?= number_format(($row['giamoi'])*$soluongmua, 0, ",", ".") ?>
        ...
        <div class="footer">
          ...
          <a class="btn btn-outline-success btn-lg"
            href="/website_tmdt/customer/purchared.php?soluongmua=<?=$soluongmua?>&masp=<?= $masp ?>">Thanh Toán</a>
        </div>
