...
<body>
  ...
  <?php } else { ?>
  <div>
    <h1 style="height: 300px; text-align: center; margin-top: 200px;">Hiện tại chưa có đơn đặt hàng nào</h1>
    <h6 style="text-align: center;">Vui lòng đặt hàng để có hóa đơn</h6>
  </div>
  <?php } ?>
