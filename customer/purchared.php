      ...
      <div class="row gx-5">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <div class="col ml-3">
            ...
            <div class="col">
              <div class="btn btnStyle"><input id="addSubmit" class="btn btn-outline font-weight-bold" style="color: #eef1f2;" name="btn_insert_ctdh" type="submit" value="Đặt Hàng" onclick="check()">
              </div>
            </div>
