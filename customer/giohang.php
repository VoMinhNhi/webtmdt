  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <div class="style-btn">
        ...
        <td colspan="2"><input type="submit" value="Xóa sản phẩm" name="remove[]" class="button-5 ml-2"></td>
        <td><input type="submit" value="Tiếp tục mua hàng" name="continue" class=" ml-2 button-5"></td>
      </div>
    </form>
