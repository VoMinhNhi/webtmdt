...
<body>
  ...
  <div class="container">
    <div class="row background">
        ...
        <div class="info-product">
          <div class="form-title">
            ...
            <div class="title-vote">
              ...
              <!-- Đêm lượt đánh giá của sản phẩm -->
              <span class="title">
                <?php
            ...
            <div class="title-price mt-3">
              ...
              <span style="color: #797979; font-size: 14px;">Gì cũng rẻ, giá tốt so với thị trường <i
              ...
              <div class="method mt-3">
                ...
                <div class="add-cart">
                  <a class="btn"
                    ...
                    name="btnThem">Thêm Vào Giỏ Hàng</a>
                </div>
                <div class="buy">
                ...
                <form action="/../website_TMDT/customer/giohang.php" method="post">
                  <fieldset>
                    ...
                    <input type="submit" name="themgiohang" value="Thêm giỏ hàng" class="btn btn-outline-info "
                      style="padding: 20px;">
                  </fieldset>
                </form>
                <div class="buy">
      ...
      <div class="col">
        <div class="detail">
          <h1 class="title">Cấu hình chi tiết: <?= $row['tenhang'] ?></h1>
                      ...
                      <div class="container">
                        ...
                        <div class="content-detail">
                          <div class="main-title">
                            ...
                            <ul class="detailCT">
                              <li class="itemCT">
                                <div class="leftdetail">Công nghệ màn hình:</div>
                                <div class="rightdetail"><?=$row['object1']?></div>
                              </li>
                              <li class="itemCT">
                                <div class="leftdetail">Độ phân giải:</div>
                                <div class="rightdetail"><?=$row['object2']?></div>
                              </li>
                              <li class="itemCT">
                                <div class="leftdetail">Màn hình rộng:</div>
                                <div class="rightdetail"><?=$row['object3']?></div>
                              </li>
                              <li class="itemCT">
                                <div class="leftdetail">Hệ điều hành:</div>
                                <div class="rightdetail"><?=$row['object5']?></div>
                              </li>
                              <li class="itemCT">
                                <div class="leftdetail">Bộ nhớ trong (ROM):</div>
                                <div class="rightdetail"><?=$row['object7']?></div>
                              </li>
                              <li class="itemCT">
                                <div class="leftdetail">Ram:</div>
