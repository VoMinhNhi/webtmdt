  ...
  <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object1" name="object1" placeholder="Công nghệ màn hình: OLED" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object2" name="object2" placeholder="Độ phân giải: 1200 x 2550 Pixels"
            class="form-control input-md" type="text">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label">Màn hình rồng</label>
        <div class="col-md-4">
          <input id="object3" name="object3" placeholder="Màn hình rộng: 6.1" class="form-control input-md" type="text">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label">Độ phân giải</label>
        <div class="col-md-4">
          <input id="object4" name="object4" placeholder="Độ phân giải: 2 camera 12MP, 12MP"
            class="form-control input-md" type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object5" name="object5" placeholder="Hệ điều hành: IOS 14" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label">Chip xử lý (CPU)</label>
        <div class="col-md-4">
          <input id="object6" name="object6" placeholder="Chip xử lý (CPU): Apple A14 Bionic 6 nhân"
            class="form-control input-md" type="text">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label">Bộ nhớ trong (ROM)</label>
        <div class="col-md-4">
          <input id="object7" name="object7" placeholder="Bộ nhớ trong (ROM): 64GM" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object8" name="object8" placeholder="Ram: 4 GB" class="form-control input-md" type="text">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label">Mạng di động</label>
        <div class="col-md-4">
          <input id="object9" name="object9" placeholder="Mạng di động: Hỗ trợ 5G" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object10" name="object10" placeholder="Số khe sim: 1 Nano SIM và 1 eSIM"
            class="form-control input-md" type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object11" name="object11" placeholder="Dung lượng pin: 2815 mAh" class="form-control input-md"
            type="text">
        </div>
      </div>
