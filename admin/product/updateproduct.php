  ...
  <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data" autocomplete="off">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="soluong" name="soluong" placeholder="Số lượng" value="<?= $sanphamRow['soluong'] ?>"
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input name="donvitinh" placeholder="Đơn vị tính" value="<?= $sanphamRow['donvitinh'] ?>"
            class=" form-control input-md" type="text">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input name="giamoi" placeholder="Giá mới" value="<?=$sanphamRow['giamoi']?>" class="form-control input-md"
            required="" type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="giacu" name="giacu" placeholder="Giá cũ" value="<?=$sanphamRow['giacu']?>" class="form-control"
            type="text">
        </div>
      </div>
